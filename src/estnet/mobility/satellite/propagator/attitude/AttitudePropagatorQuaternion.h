...
#ifndef __ESTNET_ATTITUDEPROPAGATOR_QUATERNION_H_
#define __ESTNET_ATTITUDEPROPAGATOR_QUATERNION_H_

#include "estnet/mobility/satellite/contract/IAttitudePropagator.h"
#include "estnet/mobility/satellite/propagator/attitude/state/PropStateQuaternion.h"

namespace estnet {

class ESTNET_API AttitudePropagatorQuaternion: public omnetpp::cSimpleModule,
        public AttitudePropagator<PropStateQuaternion> {
public:
    AttitudePropagatorQuaternion();
