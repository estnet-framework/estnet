...
#ifndef SATMOBILITY_PROPAGATORS_ATTITUDE_PROPSTATEQUATERNION_H_
#define SATMOBILITY_PROPAGATORS_ATTITUDE_PROPSTATEQUATERNION_H_

#include "PropStateAttitude.h"

namespace estnet {

class ESTNET_API PropStateQuaternion: public PropStateAttitude {
public:
    PropStateQuaternion();
...
private:
    cQuaternion _attitude;
    cQuaternion _angularVelocity = cQuaternion(0, 0, 0, 0);
    cQuaternion _angularAcceleration =
    cQuaternion(0, 0, 0, 0);
};

}  // namespace estnet

#endif /* SATMOBILITY_PROPAGATORS_ATTITUDE_PROPSTATEQUATERNION_H_ */
