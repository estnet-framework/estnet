...
#ifndef __ESTNET_POSITIONPROPAGATORSGP4_H_
#define __ESTNET_POSITIONPROPAGATORSGP4_H_
 ...
 */
class ESTNET_API PositionPropagatorSGP4: public PositionPropagatorSGP4Base {
protected:
    /**
...
#endif /* __ESTNET_POSITIONPROPAGATORSGP4_H_ */
