...
#ifndef __UTILS_GMSK_MODULATION_H__
#define __UTILS_GMSK_MODULATION_H__
...
/**
 * Implements BER & SER calculations for the GMSK modulation.
 */
class ESTNET_API GMSKModulation: public inet::physicallayer::ApskModulationBase {
public:
    GMSKModulation() :
